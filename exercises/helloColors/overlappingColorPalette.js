...
function overlappingColorPaletteSetup() {
  createCanvas(windowWidth, windowHeight);
  colorMode(HSB, 360, 100, 100, 100);
  noStroke();
}

function overlappingColorPalette() {
  noLoop();
  background(0);
...
function overlappingColorPaletteMouseReleased() {
  actRandomSeed = random(100000);
  loop();
}

function overlappingColorPaletteKeyPressed() {
