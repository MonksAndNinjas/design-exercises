...
global variables:
  ...
  // individual arry used to store corresponding color values
  var hueValues = [];
...
function ruleColorPaletteSetup() {
...
function ruleColorPalette() {
  ...
  for (var gridY = 0; gridY < tileCountY; gridY++) {
    for (var gridX = 0; gridX < tileCountX; gridX++) {
      ...
      var index = counter % currentTileCountX; // selects colors from arrays one by one
...
function ruleColorPalleteKeyPressed() {
  if (key == 'c' || key == 'C') {
